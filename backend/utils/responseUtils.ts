...
// Extend the Response interface to include custom methods
export const successResponse = <T>(this: Response, message: string, data?: T, statusCode: number = 200): Response => {
...
export const errorResponse = (this: Response, message: string, statusCode: number = 500): Response => {
  return this.status(statusCode).json({
    success: false,
    message,
  });
