...
@Component({
  ...
  standalone: true,
  imports: [WelcomeDateTimeComponentComponent, ViewBoxComponent, BookListViewComponent, TopChoiceListViewComponent, MemberListViewComponent, BookListViewComponent],
  templateUrl: './assistant-overview.component.html',
  styleUrl: './assistant-overview.component.scss'
})
